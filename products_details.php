...
<head>
  ...
  <title>Makeup Mosh Ordering System : Products Details</title>
  <!-- Bootstrap -->
...
<div class="container-fluid" style="text-align: center;">
  <div class="row">
    <div class="panel panel-default" style="display: inline-block; margin: 0 auto; padding: 10px; width: 50%;">
      <center>
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td><?php echo $readrow['fld_product_exp'] ?></td>
        </tr>
      </table>
      </div>
    </div>
