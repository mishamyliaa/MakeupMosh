...
<head>
  ...
  <title>Makeup Mosh Ordering System : Orders</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <!-- order id -->
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="orderdate" type="date" class="form-control" id="orderdate" placeholder="Order Date" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>" >
        </div>
        </div>
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a186913_pt2");
        $stmt->execute();
        $result = $stmt->fetchAll();
      }
      catch(PDOException $e){
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a186913_pt2, tbl_staffs_a186913_pt2, tbl_customers_a186913_pt2 WHERE ";
        $sql = $sql."tbl_orders_a186913_pt2.fld_staff_num = tbl_staffs_a186913_pt2.fld_staff_num and ";
        $sql = $sql."tbl_orders_a186913_pt2.fld_customer_num = tbl_customers_a186913_pt2.fld_customer_num";
